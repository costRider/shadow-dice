...
import { createRoom, getAllRooms, getRoomById, updateRoomStatus, addPlayerToRoom, setPlayerReady } from '../roomModel.js';
...
router.post('/create', (req, res) => {
  ...
  const room = createRoom({ title, map, maxPlayers, isPrivate, password, hostId });
  res.json({ room });
});
